...
function store_induction(num){
    $("#store_list_map").hide();
    $("#store_img").html('<img onerror="this.src='+"static/image/picture.png"+'" src="https://github.com/allen2352/grin-catmels/raw/main/'+store_list[num][7]+'" style="width:20vw;height:auto;">')
    $("#store_name").html('店名:'+store_list[num][0]);
    if(store_list[num][3]!='')category=categorylist[parseInt(store_list[num][3])];
        else{category='無';}
    $("#category").html('類別:'+category);
    $("#address").html('地址:'+store_list[num][2]);
